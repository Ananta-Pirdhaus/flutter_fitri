...
class FlipCardGame3 extends StatefulWidget {
  final Level _level;
  FlipCardGame3(this._level);

  @override
  _FlipCardGame3State createState() => _FlipCardGame3State();
}

class _FlipCardGame3State extends State<FlipCardGame3> {
            ...
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Perjuangan Para Pahlawan", // Added subtitle
                    style: TextStyle(
                      fontSize: 18.0,
