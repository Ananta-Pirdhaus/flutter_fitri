...
class FlipCardGame2 extends StatefulWidget {
  final Level _level;
  FlipCardGame2(this._level);

  @override
  _FlipCardGame2State createState() => _FlipCardGame2State();
}

class _FlipCardGame2State extends State<FlipCardGame2> {
            ...
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Budaya Negeriku", // Added subtitle
                    style: TextStyle(
                      fontSize: 18.0,
